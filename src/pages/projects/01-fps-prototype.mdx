...
The underlying Animation Sequence triggers various SFX cues and also notifies when each weapon’s mesh should be attached to a particular socket on the character’s skeletal mesh (e.g., hand versus holster).
