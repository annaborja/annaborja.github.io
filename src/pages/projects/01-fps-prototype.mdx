...
This prototype doesn’t contain a complete level, but I did implement some simple level design in the form of a tutorial level. I attempted to integrate scripted events, verticality, and affordances and signifiers to make the level objectives interesting and clear.
